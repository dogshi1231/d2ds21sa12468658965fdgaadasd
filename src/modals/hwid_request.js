...
module.exports = class HwidRequestModal extends Modal {
	...
	async run(interaction) {
		...
		try {
			...
			await client.supportRequests.recordRequest(userId, 'hwid', requestData);
			...
			await interaction.editReply({
				content: '✅ **HWID Reset Request Submitted**\n\n' +
					'Your request has been submitted to our staff team. They will review it and process it shortly.\n\n' +
			...
			client.log.error('Error processing HWID request:', error);
